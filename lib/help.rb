class Help
  def self.generate
    ...
    "Usage examples: \n"\
    "   timert start            Starts the timer at the current hour.\n"\
    "   timert start 12:20      Starts the timer at the given hour.\n"\
    "   timert stop 14          Stops the timer at the given hour.\n"\
